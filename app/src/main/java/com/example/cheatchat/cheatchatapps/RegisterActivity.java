...
public class RegisterActivity extends AppCompatActivity {
    ...
    private void CrateNewAccount() {
        ...
        if(TextUtils.isEmpty(password)){
            ...
            loadingBar.setTitle("Buat Akun Baru");
            loadingBar.setMessage("Tunggu Beberapa saat, Kami Sedang Mendaftarakan Akun anda ");
    ...
    private void InitializeFields() {
        CreateAccountButton = findViewById(R.id.regiter_button);
